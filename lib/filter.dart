...
class Filters extends StatefulWidget {
  @override
  _MyFiltersState createState() => _MyFiltersState();
}
...
class _MyFiltersState extends State<Filters> {
  ...
  List masks = [
    ...
    "assets/Alien/alien",
    "assets/Background Segmentation/background_segmentation",
    "assets/Ball Face/ball_face",
    "assets/Beard/beard",
    "assets/Beauty/beauty",
    "assets/Fairy Lights/fairy_lights",
    "assets/Flower Crown/flower_crown",
    "assets/Frankenstein/frankenstein",
    "assets/Hair Segmentation/hair_segmentation",
    "assets/Lion/lion",
    "assets/Manly Face/manly_face",
    "assets/Plastic Ocean/plastic_ocean",
    "assets/Pumpkin/pumpkin",
    "assets/Scuba/scuba",
    "assets/Tape Face/tape_face",
    "assets/Tiny Sunglasses/tiny_sunglasses",
    "assets/Topology/topology"
  ];
  List effects = [
    "none",
    "assets/fire",
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Fresh Labs Filters'),
        ),
        body: Column(
        
          children: [
            Container(child: DeepArPreview(deepArController),height: 350,),
            Container(
